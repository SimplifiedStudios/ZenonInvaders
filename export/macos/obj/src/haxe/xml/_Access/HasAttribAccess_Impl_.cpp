...
HX_LOCAL_STACK_FRAME(_hx_pos_2e3aad050e8aeaae_59_resolve,"haxe.xml._Access.HasAttribAccess_Impl_","resolve",0x7da9559c,"haxe.xml._Access.HasAttribAccess_Impl_.resolve","/usr/local/lib/haxe/std/haxe/xml/Access.hx",59,0xb9954a16)
namespace haxe{
namespace xml{
namespace _Access{
...
bool HasAttribAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_2e3aad050e8aeaae_59_resolve)
