...
HX_DEFINE_STACK_FRAME(_hx_pos_89b3abbcaec8d1d3_33_new,"haxe.zip.Reader","new",0xf101338a,"haxe.zip.Reader.new","/usr/local/lib/haxe/std/haxe/zip/Reader.hx",33,0xec337961)
HX_LOCAL_STACK_FRAME(_hx_pos_89b3abbcaec8d1d3_36_readZipDate,"haxe.zip.Reader","readZipDate",0xa6a02623,"haxe.zip.Reader.readZipDate","/usr/local/lib/haxe/std/haxe/zip/Reader.hx",36,0xec337961)
HX_LOCAL_STACK_FRAME(_hx_pos_89b3abbcaec8d1d3_48_readExtraFields,"haxe.zip.Reader","readExtraFields",0x48ea639d,"haxe.zip.Reader.readExtraFields","/usr/local/lib/haxe/std/haxe/zip/Reader.hx",48,0xec337961)
HX_LOCAL_STACK_FRAME(_hx_pos_89b3abbcaec8d1d3_78_readEntryHeader,"haxe.zip.Reader","readEntryHeader",0x28765213,"haxe.zip.Reader.readEntryHeader","/usr/local/lib/haxe/std/haxe/zip/Reader.hx",78,0xec337961)
HX_LOCAL_STACK_FRAME(_hx_pos_89b3abbcaec8d1d3_121_read,"haxe.zip.Reader","read",0xf2b0acec,"haxe.zip.Reader.read","/usr/local/lib/haxe/std/haxe/zip/Reader.hx",121,0xec337961)
HX_LOCAL_STACK_FRAME(_hx_pos_89b3abbcaec8d1d3_194_readZip,"haxe.zip.Reader","readZip",0x2845d555,"haxe.zip.Reader.readZip","/usr/local/lib/haxe/std/haxe/zip/Reader.hx",194,0xec337961)
namespace haxe{
namespace zip{

void Reader_obj::__construct( ::haxe::io::Input i){
            	HX_STACKFRAME(&_hx_pos_89b3abbcaec8d1d3_33_new)
HXDLIN(  33)		this->i = i;
            	}
...
bool Reader_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Date Reader_obj::readZipDate(){
            	HX_GC_STACKFRAME(&_hx_pos_89b3abbcaec8d1d3_36_readZipDate)
...
HX_DEFINE_DYNAMIC_FUNC0(Reader_obj,readZipDate,return )
 ...
 ::haxe::ds::List Reader_obj::readExtraFields(int length){
            	HX_GC_STACKFRAME(&_hx_pos_89b3abbcaec8d1d3_48_readExtraFields)
...
HX_DEFINE_DYNAMIC_FUNC1(Reader_obj,readExtraFields,return )
 ...
 ::Dynamic Reader_obj::readEntryHeader(){
            	HX_STACKFRAME(&_hx_pos_89b3abbcaec8d1d3_78_readEntryHeader)
...
HX_DEFINE_DYNAMIC_FUNC0(Reader_obj,readEntryHeader,return )
 ...
 ::haxe::ds::List Reader_obj::read(){
            	HX_GC_STACKFRAME(&_hx_pos_89b3abbcaec8d1d3_121_read)
...
HX_DEFINE_DYNAMIC_FUNC0(Reader_obj,read,return )
 ...
 ::haxe::ds::List Reader_obj::readZip( ::haxe::io::Input i){
            	HX_GC_STACKFRAME(&_hx_pos_89b3abbcaec8d1d3_194_readZip)
