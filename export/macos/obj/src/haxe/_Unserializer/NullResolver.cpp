...
HX_DEFINE_STACK_FRAME(_hx_pos_6789dee647201548_522_new,"haxe._Unserializer.NullResolver","new",0x49a2304b,"haxe._Unserializer.NullResolver.new","/usr/local/lib/haxe/std/haxe/Unserializer.hx",522,0x60de4a67)
HX_LOCAL_STACK_FRAME(_hx_pos_6789dee647201548_525_resolveClass,"haxe._Unserializer.NullResolver","resolveClass",0xc4a78861,"haxe._Unserializer.NullResolver.resolveClass","/usr/local/lib/haxe/std/haxe/Unserializer.hx",525,0x60de4a67)
HX_LOCAL_STACK_FRAME(_hx_pos_6789dee647201548_528_resolveEnum,"haxe._Unserializer.NullResolver","resolveEnum",0x5f3252f8,"haxe._Unserializer.NullResolver.resolveEnum","/usr/local/lib/haxe/std/haxe/Unserializer.hx",528,0x60de4a67)
namespace haxe{
namespace _Unserializer{

void NullResolver_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_6789dee647201548_522_new)
            	}
...
::hx::Class NullResolver_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_6789dee647201548_525_resolveClass)
...
::hx::Class NullResolver_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_6789dee647201548_528_resolveEnum)
