...
HX_LOCAL_STACK_FRAME(_hx_pos_916f2d3bacb9c7fb_172_charCodeAt,"_UnicodeString.UnicodeString_Impl_","charCodeAt",0xd9768435,"_UnicodeString.UnicodeString_Impl_.charCodeAt","/usr/local/lib/haxe/std/UnicodeString.hx",172,0x872b4b8d)
...
bool UnicodeString_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic UnicodeString_Impl__obj::charCodeAt(::String this1,int index){
            	HX_STACKFRAME(&_hx_pos_916f2d3bacb9c7fb_172_charCodeAt)
