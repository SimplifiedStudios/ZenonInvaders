...
HXDLIN( 629)		return this->textField->get_embedFonts();
            	}
...
HXLINE( 808)			 ::openfl::text::TextField _hx_tmp2 = this->textField;
HXDLIN( 808)			_hx_tmp2->set_height((this->get_height() * ((Float)1.2)));
...
HXDLIN( 826)		bool _hx_tmp4;
HXDLIN( 826)		if (::hx::IsNotNull( this->textField )) {
HXLINE( 826)			_hx_tmp4 = ::hx::IsNotNull( this->textField->get_text() );
            		}
            		else {
HXLINE( 826)			_hx_tmp4 = false;
            		}
HXDLIN( 826)		if (_hx_tmp4) {
HXLINE( 826)			_hx_tmp3 = (this->textField->get_text().length > 0);
            		}
            		else {
...
HXLINE( 955)				{
HXLINE( 955)					int _g2 = 0;
HXDLIN( 955)					int _g3 = iterations;
HXDLIN( 955)					while((_g2 < _g3)){
HXLINE( 955)						_g2 = (_g2 + 1);
HXDLIN( 955)						int i1 = (_g2 - 1);
HXLINE( 957)						{
HXLINE( 957)							 ::openfl::display::BitmapData graphic1;
HXDLIN( 957)							if (this->_hasBorderAlpha) {
HXLINE( 957)								graphic1 = this->_borderPixels;
            							}
            							else {
HXLINE( 957)								graphic1 = this->graphic->bitmap;
            							}
HXDLIN( 957)							this->_matrix->translate(-(curDelta),-(curDelta));
HXDLIN( 957)							this->drawTextFieldTo(graphic1);
            						}
HXLINE( 958)						{
HXLINE( 958)							 ::openfl::display::BitmapData graphic2;
HXDLIN( 958)							if (this->_hasBorderAlpha) {
HXLINE( 958)								graphic2 = this->_borderPixels;
            							}
            							else {
HXLINE( 958)								graphic2 = this->graphic->bitmap;
            							}
HXDLIN( 958)							this->_matrix->translate(curDelta,( (Float)(0) ));
HXDLIN( 958)							this->drawTextFieldTo(graphic2);
            						}
HXLINE( 959)						{
HXLINE( 959)							 ::openfl::display::BitmapData graphic3;
HXDLIN( 959)							if (this->_hasBorderAlpha) {
HXLINE( 959)								graphic3 = this->_borderPixels;
            							}
            							else {
HXLINE( 959)								graphic3 = this->graphic->bitmap;
            							}
HXDLIN( 959)							this->_matrix->translate(curDelta,( (Float)(0) ));
HXDLIN( 959)							this->drawTextFieldTo(graphic3);
            						}
HXLINE( 960)						{
HXLINE( 960)							 ::openfl::display::BitmapData graphic4;
HXDLIN( 960)							if (this->_hasBorderAlpha) {
HXLINE( 960)								graphic4 = this->_borderPixels;
            							}
            							else {
HXLINE( 960)								graphic4 = this->graphic->bitmap;
            							}
HXDLIN( 960)							this->_matrix->translate(( (Float)(0) ),curDelta);
HXDLIN( 960)							this->drawTextFieldTo(graphic4);
            						}
HXLINE( 961)						{
HXLINE( 961)							 ::openfl::display::BitmapData graphic5;
HXDLIN( 961)							if (this->_hasBorderAlpha) {
HXLINE( 961)								graphic5 = this->_borderPixels;
            							}
            							else {
HXLINE( 961)								graphic5 = this->graphic->bitmap;
            							}
HXDLIN( 961)							this->_matrix->translate(( (Float)(0) ),curDelta);
HXDLIN( 961)							this->drawTextFieldTo(graphic5);
            						}
HXLINE( 962)						{
HXLINE( 962)							 ::openfl::display::BitmapData graphic6;
HXDLIN( 962)							if (this->_hasBorderAlpha) {
HXLINE( 962)								graphic6 = this->_borderPixels;
            							}
            							else {
HXLINE( 962)								graphic6 = this->graphic->bitmap;
            							}
HXDLIN( 962)							this->_matrix->translate(-(curDelta),( (Float)(0) ));
HXDLIN( 962)							this->drawTextFieldTo(graphic6);
            						}
HXLINE( 963)						{
HXLINE( 963)							 ::openfl::display::BitmapData graphic7;
HXDLIN( 963)							if (this->_hasBorderAlpha) {
HXLINE( 963)								graphic7 = this->_borderPixels;
            							}
            							else {
HXLINE( 963)								graphic7 = this->graphic->bitmap;
            							}
HXDLIN( 963)							this->_matrix->translate(-(curDelta),( (Float)(0) ));
HXDLIN( 963)							this->drawTextFieldTo(graphic7);
            						}
HXLINE( 964)						{
HXLINE( 964)							 ::openfl::display::BitmapData graphic8;
HXDLIN( 964)							if (this->_hasBorderAlpha) {
HXLINE( 964)								graphic8 = this->_borderPixels;
            							}
            							else {
HXLINE( 964)								graphic8 = this->graphic->bitmap;
            							}
HXDLIN( 964)							this->_matrix->translate(( (Float)(0) ),-(curDelta));
HXDLIN( 964)							this->drawTextFieldTo(graphic8);
            						}
...
HXLINE( 976)				Float curDelta1 = delta;
HXLINE( 977)				{
HXLINE( 977)					int _g4 = 0;
HXDLIN( 977)					int _g5 = iterations;
HXDLIN( 977)					while((_g4 < _g5)){
HXLINE( 977)						_g4 = (_g4 + 1);
HXDLIN( 977)						int i2 = (_g4 - 1);
HXLINE( 979)						{
HXLINE( 979)							 ::openfl::display::BitmapData graphic9;
HXDLIN( 979)							if (this->_hasBorderAlpha) {
HXLINE( 979)								graphic9 = this->_borderPixels;
            							}
            							else {
HXLINE( 979)								graphic9 = this->graphic->bitmap;
            							}
HXDLIN( 979)							this->_matrix->translate(-(curDelta1),-(curDelta1));
HXDLIN( 979)							this->drawTextFieldTo(graphic9);
            						}
HXLINE( 980)						{
HXLINE( 980)							 ::openfl::display::BitmapData graphic10;
HXDLIN( 980)							if (this->_hasBorderAlpha) {
HXLINE( 980)								graphic10 = this->_borderPixels;
            							}
            							else {
HXLINE( 980)								graphic10 = this->graphic->bitmap;
            							}
HXDLIN( 980)							this->_matrix->translate((curDelta1 * ( (Float)(2) )),( (Float)(0) ));
HXDLIN( 980)							this->drawTextFieldTo(graphic10);
            						}
HXLINE( 981)						{
HXLINE( 981)							 ::openfl::display::BitmapData graphic11;
HXDLIN( 981)							if (this->_hasBorderAlpha) {
HXLINE( 981)								graphic11 = this->_borderPixels;
            							}
            							else {
HXLINE( 981)								graphic11 = this->graphic->bitmap;
            							}
HXDLIN( 981)							this->_matrix->translate(( (Float)(0) ),(curDelta1 * ( (Float)(2) )));
HXDLIN( 981)							this->drawTextFieldTo(graphic11);
            						}
HXLINE( 982)						{
HXLINE( 982)							 ::openfl::display::BitmapData graphic12;
HXDLIN( 982)							if (this->_hasBorderAlpha) {
HXLINE( 982)								graphic12 = this->_borderPixels;
            							}
            							else {
HXLINE( 982)								graphic12 = this->graphic->bitmap;
            							}
HXDLIN( 982)							this->_matrix->translate((-(curDelta1) * ( (Float)(2) )),( (Float)(0) ));
HXDLIN( 982)							this->drawTextFieldTo(graphic12);
            						}
HXLINE( 984)						this->_matrix->translate(curDelta1,-(curDelta1));
HXLINE( 985)						curDelta1 = (curDelta1 + delta);
            					}
            				}
            			}
            			break;
...
HXDLIN(1023)				_g = (_g + 1);
HXLINE(1025)				int _hx_tmp1 = (this->textField->get_text().length - 1);
HXDLIN(1025)				if (::hx::IsLess( _hx_tmp1,formatRange->range->start )) {
...
HXLINE(1034)					 ::Dynamic _hx_tmp2;
HXDLIN(1034)					if (UseBorderColor) {
HXLINE(1034)						_hx_tmp2 = (formatRange->format->borderColor & 16777215);
            					}
            					else {
HXLINE(1034)						_hx_tmp2 = textFormat->color;
            					}
HXDLIN(1034)					FormatAdjusted->color = _hx_tmp2;
            				}
HXLINE(1037)				 ::openfl::text::TextField _hx_tmp3 = this->textField;
HXDLIN(1037)				int formatRange1 = ( (int)(formatRange->range->start) );
HXDLIN(1037)				int formatRange2 = ( (int)(formatRange->range->end) );
HXDLIN(1037)				_hx_tmp3->setTextFormat(FormatAdjusted,formatRange1,::Std_obj::_hx_int(::Math_obj::min(( (Float)(formatRange2) ),( (Float)(this->textField->get_text().length) ))));
            			}
            			_hx_goto_59:;
            		}
            	}
