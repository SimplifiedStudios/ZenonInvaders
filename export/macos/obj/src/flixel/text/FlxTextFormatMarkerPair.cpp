...
HX_DEFINE_STACK_FRAME(_hx_pos_415d3a020ae56400_1132_new,"flixel.text.FlxTextFormatMarkerPair","new",0xb549f24d,"flixel.text.FlxTextFormatMarkerPair.new","flixel/text/FlxText.hx",1132,0xdf165a6e)
namespace flixel{
namespace text{

void FlxTextFormatMarkerPair_obj::__construct( ::flixel::text::FlxTextFormat format,::String marker){
            	HX_STACKFRAME(&_hx_pos_415d3a020ae56400_1132_new)
HXLINE(1133)		this->format = format;
HXLINE(1134)		this->marker = marker;
            	}
