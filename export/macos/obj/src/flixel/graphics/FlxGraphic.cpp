...
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_417_dump,"flixel.graphics.FlxGraphic","dump",0xe78dc2db,"flixel.graphics.FlxGraphic.dump","flixel/graphics/FlxGraphic.hx",417,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_431_undump,"flixel.graphics.FlxGraphic","undump",0xf6fcc174,"flixel.graphics.FlxGraphic.undump","flixel/graphics/FlxGraphic.hx",431,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_445_onContext,"flixel.graphics.FlxGraphic","onContext",0x4fa62b89,"flixel.graphics.FlxGraphic.onContext","flixel/graphics/FlxGraphic.hx",445,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_457_onAssetsReload,"flixel.graphics.FlxGraphic","onAssetsReload",0x9c63b062,"flixel.graphics.FlxGraphic.onAssetsReload","flixel/graphics/FlxGraphic.hx",457,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_471_destroy,"flixel.graphics.FlxGraphic","destroy",0x6c66a9b3,"flixel.graphics.FlxGraphic.destroy","flixel/graphics/FlxGraphic.hx",471,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_507_addFrameCollection,"flixel.graphics.FlxGraphic","addFrameCollection",0x06dd03b1,"flixel.graphics.FlxGraphic.addFrameCollection","flixel/graphics/FlxGraphic.hx",507,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_521_getFramesCollections,"flixel.graphics.FlxGraphic","getFramesCollections",0xa4089c80,"flixel.graphics.FlxGraphic.getFramesCollections","flixel/graphics/FlxGraphic.hx",521,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_539_getEmptyFrame,"flixel.graphics.FlxGraphic","getEmptyFrame",0xc5b0f80f,"flixel.graphics.FlxGraphic.getEmptyFrame","flixel/graphics/FlxGraphic.hx",539,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_575_getBitmapFromSystem,"flixel.graphics.FlxGraphic","getBitmapFromSystem",0xb3be27b7,"flixel.graphics.FlxGraphic.getBitmapFromSystem","flixel/graphics/FlxGraphic.hx",575,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_590_get_isLoaded,"flixel.graphics.FlxGraphic","get_isLoaded",0xcad65c3f,"flixel.graphics.FlxGraphic.get_isLoaded","flixel/graphics/FlxGraphic.hx",590,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_595_get_canBeDumped,"flixel.graphics.FlxGraphic","get_canBeDumped",0x9b8a5e36,"flixel.graphics.FlxGraphic.get_canBeDumped","flixel/graphics/FlxGraphic.hx",595,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_600_get_useCount,"flixel.graphics.FlxGraphic","get_useCount",0x2bcc1fb8,"flixel.graphics.FlxGraphic.get_useCount","flixel/graphics/FlxGraphic.hx",600,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_604_set_useCount,"flixel.graphics.FlxGraphic","set_useCount",0x40c5432c,"flixel.graphics.FlxGraphic.set_useCount","flixel/graphics/FlxGraphic.hx",604,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_613_get_destroyOnNoUse,"flixel.graphics.FlxGraphic","get_destroyOnNoUse",0x7e860bbd,"flixel.graphics.FlxGraphic.get_destroyOnNoUse","flixel/graphics/FlxGraphic.hx",613,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_617_set_destroyOnNoUse,"flixel.graphics.FlxGraphic","set_destroyOnNoUse",0x5b353e31,"flixel.graphics.FlxGraphic.set_destroyOnNoUse","flixel/graphics/FlxGraphic.hx",617,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_625_get_imageFrame,"flixel.graphics.FlxGraphic","get_imageFrame",0xc1224382,"flixel.graphics.FlxGraphic.get_imageFrame","flixel/graphics/FlxGraphic.hx",625,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_634_get_atlasFrames,"flixel.graphics.FlxGraphic","get_atlasFrames",0x774c10a1,"flixel.graphics.FlxGraphic.get_atlasFrames","flixel/graphics/FlxGraphic.hx",634,0xb3633517)
HX_LOCAL_STACK_FRAME(_hx_pos_3b8710f86d15c371_638_set_bitmap,"flixel.graphics.FlxGraphic","set_bitmap",0x39ee9b13,"flixel.graphics.FlxGraphic.set_bitmap","flixel/graphics/FlxGraphic.hx",638,0xb3633517)
...
HXLINE( 388)		this->_destroyOnNoUse = true;
HXLINE( 386)		this->_useCount = 0;
...
HXLINE( 400)		this->key = Key;
HXLINE( 401)		bool _hx_tmp;
HXDLIN( 401)		if (::hx::IsNotNull( Persist )) {
HXLINE( 401)			_hx_tmp = ( (bool)(Persist) );
            		}
            		else {
HXLINE( 401)			_hx_tmp = ::flixel::graphics::FlxGraphic_obj::defaultPersist;
            		}
HXDLIN( 401)		this->persist = _hx_tmp;
HXLINE( 403)		this->frameCollections =  ::haxe::ds::EnumValueMap_obj::__alloc( HX_CTX );
HXLINE( 404)		this->frameCollectionTypes = ::Array_obj< ::Dynamic>::__new();
HXLINE( 405)		this->set_bitmap(Bitmap);
HXLINE( 408)		this->shader =  ::flixel::graphics::tile::FlxGraphicsShader_obj::__alloc( HX_CTX );
            	}
...
void FlxGraphic_obj::dump(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_417_dump)
            	}
...
void FlxGraphic_obj::undump(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_431_undump)
HXLINE( 432)		 ::openfl::display::BitmapData newBitmap = this->getBitmapFromSystem();
HXLINE( 433)		if (::hx::IsNotNull( newBitmap )) {
HXLINE( 434)			this->set_bitmap(newBitmap);
            		}
HXLINE( 435)		this->isDumped = false;
            	}
...
void FlxGraphic_obj::onContext(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_445_onContext)
HXDLIN( 445)		if (this->isDumped) {
HXLINE( 447)			this->undump();
HXLINE( 448)			this->dump();
            		}
            	}
...
void FlxGraphic_obj::onAssetsReload(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_457_onAssetsReload)
HXLINE( 458)		bool _hx_tmp;
HXDLIN( 458)		if (::hx::IsNull( this->assetsClass )) {
HXLINE( 458)			_hx_tmp = ::hx::IsNotNull( this->assetsKey );
            		}
            		else {
...
HXLINE( 461)		bool dumped = this->isDumped;
HXLINE( 462)		this->undump();
HXLINE( 463)		if (dumped) {
HXLINE( 464)			this->dump();
            		}
            	}
...
void FlxGraphic_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_471_destroy)
HXLINE( 472)		this->set_bitmap(::flixel::util::FlxDestroyUtil_obj::dispose(this->bitmap));
HXLINE( 475)		this->shader = null();
HXLINE( 481)		this->key = null();
HXLINE( 482)		this->assetsKey = null();
HXLINE( 483)		this->assetsClass = null();
HXLINE( 484)		this->_imageFrame = null();
HXLINE( 486)		if (::hx::IsNull( this->frameCollections )) {
HXLINE( 487)			return;
            		}
HXLINE( 489)		::Array< ::Dynamic> collections;
HXLINE( 490)		{
HXLINE( 490)			int _g = 0;
HXDLIN( 490)			::Array< ::Dynamic> _g1 = this->frameCollectionTypes;
HXDLIN( 490)			while((_g < _g1->length)){
HXLINE( 490)				 ::flixel::graphics::frames::FlxFrameCollectionType collectionType = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrameCollectionType >();
HXDLIN( 490)				_g = (_g + 1);
HXLINE( 492)				collections = ( (::Array< ::Dynamic>)(this->frameCollections->get(collectionType)) );
HXLINE( 493)				::flixel::util::FlxDestroyUtil_obj::destroyArray(collections);
            			}
            		}
HXLINE( 496)		this->frameCollections = null();
HXLINE( 497)		this->frameCollectionTypes = null();
            	}
...
void FlxGraphic_obj::addFrameCollection( ::flixel::graphics::frames::FlxFramesCollection collection){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_507_addFrameCollection)
HXDLIN( 507)		if (::hx::IsNotNull( collection->type )) {
HXLINE( 509)			 ::flixel::graphics::frames::FlxFrameCollectionType type = collection->type;
HXDLIN( 509)			::cpp::VirtualArray collections = ( (::cpp::VirtualArray)(this->frameCollections->get(type)) );
HXDLIN( 509)			if (::hx::IsNull( collections )) {
HXLINE( 509)				collections = ::Array_obj< ::Dynamic>::__new();
HXDLIN( 509)				this->frameCollections->set(type,collections);
            			}
HXDLIN( 509)			::cpp::VirtualArray collections1 = collections;
HXLINE( 510)			collections1->push(collection);
            		}
            	}
...
::cpp::VirtualArray FlxGraphic_obj::getFramesCollections( ::flixel::graphics::frames::FlxFrameCollectionType type){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_521_getFramesCollections)
HXLINE( 522)		::cpp::VirtualArray collections = ( (::cpp::VirtualArray)(this->frameCollections->get(type)) );
HXLINE( 523)		if (::hx::IsNull( collections )) {
HXLINE( 525)			collections = ::Array_obj< ::Dynamic>::__new();
HXLINE( 526)			this->frameCollections->set(type,collections);
            		}
HXLINE( 528)		return collections;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGraphic_obj,getFramesCollections,return )
 ...
 ::flixel::graphics::frames::FlxFrame FlxGraphic_obj::getEmptyFrame( ::flixel::math::FlxBasePoint size){
            	HX_GC_STACKFRAME(&_hx_pos_3b8710f86d15c371_539_getEmptyFrame)
HXLINE( 540)		 ::flixel::graphics::frames::FlxFrame frame =  ::flixel::graphics::frames::FlxFrame_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),null(),null(),null(),null());
HXLINE( 541)		frame->type = 2;
HXLINE( 542)		 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 542)		_this->x = ( (Float)(0) );
HXDLIN( 542)		_this->y = ( (Float)(0) );
HXDLIN( 542)		_this->width = ( (Float)(0) );
HXDLIN( 542)		_this->height = ( (Float)(0) );
HXDLIN( 542)		 ::flixel::math::FlxRect rect = _this;
HXDLIN( 542)		rect->_inPool = false;
HXDLIN( 542)		frame->set_frame(rect);
HXLINE( 543)		{
HXLINE( 543)			 ::flixel::math::FlxBasePoint this1 = frame->sourceSize;
HXDLIN( 543)			{
HXLINE( 543)				Float y = size->y;
HXDLIN( 543)				this1->set_x(size->x);
HXDLIN( 543)				this1->set_y(y);
            			}
HXDLIN( 543)			if (size->_weak) {
HXLINE( 543)				size->put();
            			}
            		}
HXLINE( 544)		return frame;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGraphic_obj,getEmptyFrame,return )
 ...
 ::openfl::display::BitmapData FlxGraphic_obj::getBitmapFromSystem(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_575_getBitmapFromSystem)
HXLINE( 576)		 ::openfl::display::BitmapData newBitmap = null();
HXLINE( 577)		if (::hx::IsNotNull( this->assetsClass )) {
HXLINE( 578)			newBitmap = ( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(this->assetsClass,::cpp::VirtualArray_obj::__new(0))) );
            		}
            		else {
HXLINE( 579)			if (::hx::IsNotNull( this->assetsKey )) {
HXLINE( 580)				::String id = this->assetsKey;
HXDLIN( 580)				if (::openfl::utils::Assets_obj::exists(id,null())) {
HXLINE( 580)					newBitmap = ::openfl::utils::Assets_obj::getBitmapData(id,false);
            				}
            				else {
HXLINE( 580)					newBitmap = null();
            				}
            			}
            		}
HXLINE( 582)		if (::hx::IsNotNull( newBitmap )) {
HXLINE( 583)			if (this->unique) {
HXLINE( 583)				return newBitmap->clone();
            			}
            			else {
HXLINE( 583)				return newBitmap;
            			}
            		}
...
bool FlxGraphic_obj::get_isLoaded(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_590_get_isLoaded)
HXDLIN( 590)		if (::hx::IsNotNull( this->bitmap )) {
HXDLIN( 590)			return !(this->bitmap->rect->isEmpty());
            		}
            		else {
...
bool FlxGraphic_obj::get_canBeDumped(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_595_get_canBeDumped)
HXDLIN( 595)		if (::hx::IsNull( this->assetsClass )) {
HXDLIN( 595)			return ::hx::IsNotNull( this->assetsKey );
            		}
            		else {
HXDLIN( 595)			return true;
            		}
...
int FlxGraphic_obj::get_useCount(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_600_get_useCount)
HXDLIN( 600)		return this->_useCount;
            	}
...
int FlxGraphic_obj::set_useCount(int Value){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_604_set_useCount)
HXLINE( 605)		bool _hx_tmp;
HXDLIN( 605)		bool _hx_tmp1;
HXDLIN( 605)		if ((Value <= 0)) {
HXLINE( 605)			_hx_tmp1 = this->_destroyOnNoUse;
            		}
            		else {
...
HXLINE( 608)		return (this->_useCount = Value);
            	}
...
bool FlxGraphic_obj::get_destroyOnNoUse(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_613_get_destroyOnNoUse)
HXDLIN( 613)		return this->_destroyOnNoUse;
            	}
...
bool FlxGraphic_obj::set_destroyOnNoUse(bool Value){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_617_set_destroyOnNoUse)
HXLINE( 618)		bool _hx_tmp;
HXDLIN( 618)		bool _hx_tmp1;
HXDLIN( 618)		bool _hx_tmp2;
HXDLIN( 618)		if (Value) {
HXLINE( 618)			_hx_tmp2 = (this->_useCount <= 0);
            		}
            		else {
HXLINE( 618)			_hx_tmp2 = false;
            		}
HXDLIN( 618)		if (_hx_tmp2) {
HXLINE( 618)			_hx_tmp1 = ::hx::IsNotNull( this->key );
            		}
            		else {
HXLINE( 618)			_hx_tmp1 = false;
            		}
HXDLIN( 618)		if (_hx_tmp1) {
HXLINE( 618)			_hx_tmp = !(this->persist);
            		}
            		else {
HXLINE( 618)			_hx_tmp = false;
            		}
HXDLIN( 618)		if (_hx_tmp) {
HXLINE( 619)			::flixel::FlxG_obj::bitmap->remove(::hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE( 621)		return (this->_destroyOnNoUse = Value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGraphic_obj,set_destroyOnNoUse,return )
 ...
 ::flixel::graphics::frames::FlxImageFrame FlxGraphic_obj::get_imageFrame(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_625_get_imageFrame)
HXLINE( 626)		if (::hx::IsNull( this->_imageFrame )) {
HXLINE( 627)			Float Width = ( (Float)(this->bitmap->width) );
HXDLIN( 627)			Float Height = ( (Float)(this->bitmap->height) );
HXDLIN( 627)			 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 627)			_this->x = ( (Float)(0) );
HXDLIN( 627)			_this->y = ( (Float)(0) );
HXDLIN( 627)			_this->width = Width;
HXDLIN( 627)			_this->height = Height;
HXDLIN( 627)			 ::flixel::math::FlxRect rect = _this;
HXDLIN( 627)			rect->_inPool = false;
HXDLIN( 627)			this->_imageFrame = ::flixel::graphics::frames::FlxImageFrame_obj::fromRectangle(::hx::ObjectPtr<OBJ_>(this),rect);
            		}
HXLINE( 629)		return this->_imageFrame;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxGraphic_obj,get_imageFrame,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames FlxGraphic_obj::get_atlasFrames(){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_634_get_atlasFrames)
HXDLIN( 634)		return ::flixel::graphics::frames::FlxAtlasFrames_obj::findFrame(::hx::ObjectPtr<OBJ_>(this),null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxGraphic_obj,get_atlasFrames,return )
 ...
 ::openfl::display::BitmapData FlxGraphic_obj::set_bitmap( ::openfl::display::BitmapData value){
            	HX_STACKFRAME(&_hx_pos_3b8710f86d15c371_638_set_bitmap)
HXLINE( 639)		if (::hx::IsNotNull( value )) {
HXLINE( 641)			this->bitmap = value;
HXLINE( 642)			this->width = this->bitmap->width;
HXLINE( 643)			this->height = this->bitmap->height;
            		}
