...
HXLINE(  85)			int _g2 = 0;
HXDLIN(  85)			::Array< ::String > _g3 = ::Reflect_obj::fields( ::Dynamic(data->__Field(HX_("frames",a6,af,85,ac),::hx::paccDynamic)));
HXDLIN(  85)			while((_g2 < _g3->length)){
HXLINE(  85)				::String frameName = _g3->__get(_g2);
HXDLIN(  85)				_g2 = (_g2 + 1);
...
HXLINE( 115)			Float X1 = ( (Float)(frame->__Field(HX_("x",78,00,00,00),::hx::paccDynamic)) );
HXDLIN( 115)			Float Y1 = ( (Float)(frame->__Field(HX_("y",79,00,00,00),::hx::paccDynamic)) );
HXDLIN( 115)			Float Width1 = ( (Float)(frame->__Field(HX_("w",77,00,00,00),::hx::paccDynamic)) );
HXDLIN( 115)			Float Height1 = ( (Float)(frame->__Field(HX_("h",68,00,00,00),::hx::paccDynamic)) );
HXDLIN( 115)			 ::flixel::math::FlxRect _this1 = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 115)			_this1->x = X1;
HXDLIN( 115)			_this1->y = Y1;
HXDLIN( 115)			_this1->width = Width1;
HXDLIN( 115)			_this1->height = Height1;
HXDLIN( 115)			 ::flixel::math::FlxRect rect1 = _this1;
HXDLIN( 115)			rect1->_inPool = false;
HXDLIN( 115)			frameRect = rect1;
            		}
...
HXLINE( 247)			HX_STACK_DO_THROW((HX_("Invalid nodeType ",3b,e0,cb,e1) + ::_Xml::XmlType_Impl__obj::toString(x->nodeType)));
            		}
HXDLIN( 247)		 ::Xml data = x;
HXLINE( 249)		{
HXLINE( 249)			int _g = 0;
...
HXLINE( 272)				Float x1 = -(size->get_left());
HXDLIN( 272)				Float y = -(size->get_top());
HXDLIN( 272)				 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x1,y);
HXDLIN( 272)				point->_inPool = false;
HXDLIN( 272)				 ::flixel::math::FlxBasePoint offset = point;
HXLINE( 273)				Float x2 = size->width;
HXDLIN( 273)				Float y1 = size->height;
HXDLIN( 273)				 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x2,y1);
...
HXLINE( 275)					_hx_tmp2 = !(trimmed);
            				}
            				else {
HXLINE( 275)					_hx_tmp2 = false;
            				}
HXDLIN( 275)				if (_hx_tmp2) {
HXLINE( 276)					Float y2 = size->width;
HXDLIN( 276)					sourceSize->set_x(size->height);
HXDLIN( 276)					sourceSize->set_y(y2);
            				}
...
HXLINE( 322)					{
HXLINE( 322)						Float x1 = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("oX",09,61,00,00)))) );
HXDLIN( 322)						Float y1 = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("oY",0a,61,00,00)))) );
HXDLIN( 322)						offset->set_x(x1);
HXDLIN( 322)						offset->set_y(y1);
            					}
HXLINE( 323)					{
HXLINE( 323)						Float x2 = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("oW",08,61,00,00)))) );
HXDLIN( 323)						Float y2 = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("oH",f9,60,00,00)))) );
HXDLIN( 323)						sourceSize->set_x(x2);
HXDLIN( 323)						sourceSize->set_y(y2);
            					}
            				}
