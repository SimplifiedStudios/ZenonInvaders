...
HXDLIN( 239)			 ::flixel::graphics::frames::FlxFrame _g_value = ( ( ::flixel::graphics::frames::FlxFrame)(::haxe::IMap_obj::get(_g_map,key)) );
HXDLIN( 239)			::String _g_key = key;
HXDLIN( 239)			::String name = _g_key;
HXDLIN( 239)			 ::flixel::graphics::frames::FlxFrame frame = _g_value;
...
HXDLIN( 258)			 ::flixel::graphics::frames::FlxFrame _g_value = ( ( ::flixel::graphics::frames::FlxFrame)(::haxe::IMap_obj::get(_g_map,key)) );
HXDLIN( 258)			::String _g_key = key;
HXDLIN( 258)			::String name = _g_key;
HXDLIN( 258)			 ::flixel::graphics::frames::FlxFrame frame = _g_value;
...
HXDLIN( 295)			 ::flixel::graphics::frames::FlxFrame _g_value = ( ( ::flixel::graphics::frames::FlxFrame)(::haxe::IMap_obj::get(_g_map,key)) );
HXDLIN( 295)			::String _g_key = key;
HXDLIN( 295)			::String name = _g_key;
HXDLIN( 295)			 ::flixel::graphics::frames::FlxFrame frame = _g_value;
...
HXDLIN( 354)		HX_STACK_DO_THROW(HX_("To be overriden in subclasses",8b,78,89,60));
