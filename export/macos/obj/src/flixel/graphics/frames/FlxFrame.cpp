...
HXLINE( 114)		this->blitMatrix = ::Array_obj< Float >::__new(6);
HXLINE( 115)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 116)			this->tileMatrix = ::Array_obj< Float >::__new(6);
            		}
            	}
...
HXLINE( 133)			{
HXLINE( 133)				 ::flixel::math::FlxMatrix mat1 = this->matrix;
HXDLIN( 133)				mat1->identity();
HXDLIN( 133)				if ((this->angle == 90)) {
HXLINE( 133)					mat1->setTo(-(mat1->b),mat1->a,-(mat1->d),mat1->c,-(mat1->ty),mat1->tx);
HXDLIN( 133)					mat1->translate(this->frame->height,( (Float)(0) ));
            				}
            				else {
HXLINE( 133)					if ((this->angle == -90)) {
HXLINE( 133)						mat1->setTo(mat1->b,-(mat1->a),mat1->d,-(mat1->c),mat1->ty,-(mat1->tx));
HXDLIN( 133)						mat1->translate(( (Float)(0) ),this->frame->width);
            					}
            				}
HXDLIN( 133)				mat1->translate(this->offset->x,this->offset->y);
            			}
...
HXDLIN( 268)				if ((rotation != -90)) {
HXLINE( 268)					_hx_tmp2 = (rotation == -90);
            				}
            				else {
...
HXDLIN( 318)			Float x1 = (_this1->x + _this1->width);
HXDLIN( 318)			 ::flixel::math::FlxRect _this2 = this->frame;
HXDLIN( 318)			Float y1 = (_this2->y + _this2->height);
...
HXDLIN( 318)			 ::flixel::math::FlxRect _this3 = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 318)			_this3->x = ( (Float)(0) );
HXDLIN( 318)			_this3->y = ( (Float)(0) );
HXDLIN( 318)			_this3->width = ( (Float)(0) );
HXDLIN( 318)			_this3->height = ( (Float)(0) );
HXDLIN( 318)			 ::flixel::math::FlxRect rect = _this3;
HXDLIN( 318)			rect->_inPool = false;
HXDLIN( 318)			 ::flixel::math::FlxRect _this4 = rect;
...
HXDLIN( 318)			_this4->x = minX;
HXDLIN( 318)			_this4->y = minY;
HXDLIN( 318)			_this4->width = (maxX - minX);
HXDLIN( 318)			_this4->height = (maxY - minY);
HXDLIN( 318)			 ::flixel::math::FlxRect flxRect = _this4;
HXDLIN( 318)			{
HXLINE( 318)				 ::openfl::geom::Rectangle FlashRect1 = this->rect;
HXDLIN( 318)				if (::hx::IsNull( FlashRect1 )) {
HXLINE( 318)					FlashRect1 =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            				}
HXDLIN( 318)				FlashRect1->x = flxRect->x;
HXDLIN( 318)				FlashRect1->y = flxRect->y;
HXDLIN( 318)				FlashRect1->width = flxRect->width;
HXDLIN( 318)				FlashRect1->height = flxRect->height;
            			}
...
HXDLIN( 487)			 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x,y4);
...
HXDLIN( 488)			 ::flixel::math::FlxBasePoint point3 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x1,y5);
...
HXLINE( 494)				{
HXLINE( 494)					 ::flixel::math::FlxMatrix _this2 = this->matrix;
...
HXLINE( 499)					{
HXLINE( 499)						 ::flixel::math::FlxMatrix _this3 = this->matrix;
...
HXDLIN( 589)			 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x,y3);
...
HXDLIN( 590)			 ::flixel::math::FlxBasePoint point3 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x1,y4);
...
HXLINE( 596)				{
HXLINE( 596)					 ::flixel::math::FlxMatrix _this2 = this->matrix;
...
HXLINE( 601)					{
HXLINE( 601)						 ::flixel::math::FlxMatrix _this3 = this->matrix;
