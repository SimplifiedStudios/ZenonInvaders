...
HXDLIN( 682)				 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x1,y1);
...
HXDLIN( 683)				 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(x3,y3);
HXDLIN( 683)				point1->_inPool = false;
HXLINE( 682)				sourceSize = point1;
            			}
HXLINE( 684)			 ::flixel::math::FlxBasePoint point2 = ::flixel::math::FlxBasePoint_obj::pool->get()->set(0,0);
