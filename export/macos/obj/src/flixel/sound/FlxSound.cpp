...
HXLINE( 299)				Float lowerBound1;
HXDLIN( 299)				if ((d < -1)) {
HXLINE( 299)					lowerBound1 = ( (Float)(-1) );
            				}
            				else {
HXLINE( 299)					lowerBound1 = d;
            				}
HXDLIN( 299)				Float _hx_tmp;
HXDLIN( 299)				if ((lowerBound1 > 1)) {
HXLINE( 299)					_hx_tmp = ( (Float)(1) );
            				}
            				else {
HXLINE( 299)					_hx_tmp = lowerBound1;
            				}
...
HXLINE( 319)			_hx_tmp1 = ::hx::IsGreaterEq( this->_time,this->endTime );
            		}
            		else {
