...
HXLINE( 203)			bool _hx_tmp3;
HXDLIN( 203)			if ((this->_frameTimer > curFrameDuration)) {
HXLINE( 203)				_hx_tmp3 = !(this->finished);
            			}
            			else {
...
HXLINE( 205)			 ::flixel::animation::FlxAnimation _hx_tmp4 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 205)			_hx_tmp4->_frameTimer = (_hx_tmp4->_frameTimer - curFrameDuration);
HXLINE( 206)			if (this->reversed) {
HXLINE( 208)				bool _hx_tmp5;
HXDLIN( 208)				if (this->looped) {
HXLINE( 208)					_hx_tmp5 = (this->curFrame == this->loopPoint);
            				}
            				else {
...
HXLINE( 215)					_hx_tmp6 = (this->curFrame == (this->frames->length - 1));
            				}
            				else {
...
HXLINE( 257)				int _hx_tmp1;
HXDLIN( 257)				if (this->reversed) {
HXLINE( 257)					_hx_tmp1 = 0;
            				}
            				else {
HXLINE( 257)					_hx_tmp1 = maxFrameIndex;
            				}
HXDLIN( 257)				this->curFrame = _hx_tmp1;
            			}
            			else {
...
HXLINE( 269)			_hx_tmp2 = ::hx::IsNotNull( this->parent );
            		}
            		else {
