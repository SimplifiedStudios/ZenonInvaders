...
HXLINE( 759)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get()->set(xAxis,yAxis);
...
HXDLIN( 893)		 ::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 893)		_this->label = HX_("id",db,5b,00,00);
HXDLIN( 893)		_this->value = value;
HXLINE( 894)		 ::Dynamic value1 = this->model;
HXDLIN( 894)		 ::flixel::util::LabelValuePair _this1 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 894)		_this1->label = HX_("model",a9,23,58,0c);
HXDLIN( 894)		_this1->value = value1;
HXLINE( 895)		 ::Dynamic value2 = this->get_deadZone();
HXDLIN( 895)		 ::flixel::util::LabelValuePair _this2 = ::flixel::util::LabelValuePair_obj::_pool->get();
