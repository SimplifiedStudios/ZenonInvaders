...
HXLINE( 514)			bool _hx_tmp1 = (frameHeight > graph->height);
            		}
...
HXLINE( 791)					_hx_tmp2 = !(camera->exists);
            				}
            				else {
HXLINE( 791)					_hx_tmp2 = true;
            				}
HXDLIN( 791)				if (!(_hx_tmp2)) {
HXLINE( 791)					_hx_tmp1 = !(this->isOnScreen(camera));
            				}
            				else {
...
HXLINE( 815)			 ::flixel::math::FlxBasePoint this2 = this->_point;
HXDLIN( 815)			this2->set_x(( (Float)(::Math_obj::floor(this2->x)) ));
HXDLIN( 815)			this2->set_y(( (Float)(::Math_obj::floor(this2->y)) ));
            		}
HXLINE( 817)		{
HXLINE( 817)			 ::flixel::math::FlxBasePoint this3 = this->_point;
...
HXDLIN( 817)			p->x = this3->x;
HXDLIN( 817)			p->y = this3->y;
            		}
...
HXLINE( 862)			HX_STACK_DO_THROW(HX_("Cannot stamp to or from a FlxSprite with no graphics.",72,0b,d4,aa));
            		}
...
HXLINE(1040)			int _hx_tmp3 = ::Std_obj::_hx_int(this->_point->x);
HXDLIN(1040)			return frameData->getPixel32(_hx_tmp3,::Std_obj::_hx_int(this->_point->y));
            		}
...
HXLINE(1568)			_hx_tmp1 = this->dirty;
            		}
            		else {
HXLINE(1568)			_hx_tmp1 = true;
            		}
HXDLIN(1568)		this->dirty = _hx_tmp1;
