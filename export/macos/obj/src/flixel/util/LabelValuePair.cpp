...
HXDLIN( 690)		 ::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get();
...
HXDLIN( 686)		_pool =  ::flixel::util::FlxPool_flixel_util_LabelValuePair_obj::__alloc( HX_CTX ,::hx::ClassOf< ::flixel::util::LabelValuePair >());
            	}
}
