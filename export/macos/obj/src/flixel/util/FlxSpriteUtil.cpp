...
HXDLIN( 180)			int dir1 = 16;
HXDLIN( 180)			if (((edges & dir1) == dir1)) {
HXLINE( 180)				_hx_tmp1 = (spriteBounds->x > (camera->scroll->x + (( (Float)(camera->width) ) - camera->viewMarginX)));
            			}
            			else {
...
HXDLIN( 183)		int dir2 = 256;
HXDLIN( 183)		if (((edges & dir2) == dir2)) {
HXLINE( 183)			_hx_tmp2 = ((spriteBounds->y + spriteBounds->height) < (camera->scroll->y + camera->viewMarginY));
            		}
            		else {
...
HXDLIN( 185)			int dir3 = 4096;
HXDLIN( 185)			if (((edges & dir3) == dir3)) {
HXLINE( 185)				_hx_tmp3 = (spriteBounds->y > (camera->scroll->y + (( (Float)(camera->height) ) - camera->viewMarginY)));
            			}
            			else {
...
HXDLIN( 216)			int dir1 = 16;
HXDLIN( 216)			if (((edges & dir1) == dir1)) {
HXLINE( 216)				_hx_tmp1 = ((spriteBounds->x + spriteBounds->width) > (camera->scroll->x + (( (Float)(camera->width) ) - camera->viewMarginX)));
            			}
            			else {
...
HXDLIN( 219)		int dir2 = 256;
HXDLIN( 219)		if (((edges & dir2) == dir2)) {
HXLINE( 219)			_hx_tmp2 = (spriteBounds->y < (camera->scroll->y + camera->viewMarginY));
            		}
            		else {
...
HXDLIN( 221)			int dir3 = 4096;
HXDLIN( 221)			if (((edges & dir3) == dir3)) {
HXLINE( 221)				_hx_tmp3 = ((spriteBounds->y + spriteBounds->height) > (camera->scroll->y + (( (Float)(camera->height) ) - camera->viewMarginY)));
            			}
            			else {
...
HXLINE( 557)				 ::flixel::math::FlxBasePoint p1 = Vertices->__get(_g).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN( 557)				_g = (_g + 1);
HXLINE( 559)				::flixel::util::FlxSpriteUtil_obj::flashGfx->lineTo(p1->x,p1->y);
            			}
            		}
HXLINE( 561)		{
