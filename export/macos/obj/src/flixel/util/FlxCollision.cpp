...
HXLINE( 254)				 ::flixel::math::FlxRect _this1 = ::flixel::FlxG_obj::worldBounds;
HXDLIN( 254)				_this1->x = Camera->x;
HXDLIN( 254)				_this1->y = Camera->y;
HXDLIN( 254)				_this1->width = ( (Float)(Camera->width) );
HXDLIN( 254)				_this1->height = ( (Float)(Camera->height) );
            			}
            		}
