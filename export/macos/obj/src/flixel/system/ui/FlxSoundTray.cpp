...
HXDLIN( 122)				this->set_y((_hx_tmp2 - (((MS / ( (Float)(1000) )) * ( (Float)(::flixel::FlxG_obj::height) )) * ( (Float)(2) ))));
...
HXLINE( 130)						::String _g1 = _g->_hx_getString(0);
HXDLIN( 130)						::String _g2 = _g->_hx_getString(1);
HXDLIN( 130)						_hx_tmp4 = true;
            					}
            					else {
