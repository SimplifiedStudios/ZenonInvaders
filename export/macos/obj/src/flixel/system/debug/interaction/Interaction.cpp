...
HXLINE(  39)		this->flixelPointer =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ));
...
HXLINE( 257)		this->flixelPointer = ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::destroy(this->flixelPointer)) );
...
HXDLIN( 344)				_g = (_g + 1);
HXLINE( 345)				if (::Std_obj::isOfType(tool,className)) {
...
HXLINE( 450)		if (::hx::IsInstanceEq( this->activeTool,value )) {
