...
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_312_update,"flixel.system.debug.Window","update",0xcd50591f,"flixel.system.debug.Window.update","flixel/system/debug/Window.hx",312,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_320_init,"flixel.system.debug.Window","init",0x33a1fca6,"flixel.system.debug.Window.init","flixel/system/debug/Window.hx",320,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_338_onMouseMove,"flixel.system.debug.Window","onMouseMove",0xdd6abbe1,"flixel.system.debug.Window.onMouseMove","flixel/system/debug/Window.hx",338,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_378_onMouseDown,"flixel.system.debug.Window","onMouseDown",0xd777d132,"flixel.system.debug.Window.onMouseDown","flixel/system/debug/Window.hx",378,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_400_onMouseUp,"flixel.system.debug.Window","onMouseUp",0x62a36b2b,"flixel.system.debug.Window.onMouseUp","flixel/system/debug/Window.hx",400,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_410_bound,"flixel.system.debug.Window","bound",0xf2ff51e8,"flixel.system.debug.Window.bound","flixel/system/debug/Window.hx",410,0xb8dfd4e5)
HX_LOCAL_STACK_FRAME(_hx_pos_4e51d5a8805713a4_421_updateSize,"flixel.system.debug.Window","updateSize",0x6f89a180,"flixel.system.debug.Window.updateSize","flixel/system/debug/Window.hx",421,0xb8dfd4e5)
...
HXLINE( 264)			 ::flixel::util::FlxSaveStatus _g = ::flixel::FlxG_obj::save->status;
HXDLIN( 264)			if ((_g->_hx_getIndex() == 1)) {
HXLINE( 264)				::String _g1 = _g->_hx_getString(0);
HXDLIN( 264)				::String _g2 = _g->_hx_getString(1);
HXDLIN( 264)				_hx_tmp = true;
            			}
            			else {
...
void Window_obj::update(){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_312_update)
            	}
...
void Window_obj::init( ::openfl::events::Event _){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_320_init)
HXLINE( 321)		if (::hx::IsNull( this->stage )) {
HXLINE( 323)			return;
            		}
HXLINE( 325)		this->removeEventListener(HX_("enterFrame",f5,03,50,02),this->init_dyn(),null());
HXLINE( 327)		this->stage->addEventListener(HX_("mouseMove",d6,9b,b5,f4),this->onMouseMove_dyn(),null(),null(),null());
HXLINE( 328)		this->stage->addEventListener(HX_("mouseUp",e0,f3,72,c0),this->onMouseUp_dyn(),null(),null(),null());
HXLINE( 331)		this->addEventListener(HX_("mouseDown",27,b1,c2,ee),this->onMouseDown_dyn(),null(),null(),null());
            	}
...
void Window_obj::onMouseMove( ::openfl::events::MouseEvent _){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_338_onMouseMove)
HXLINE( 340)		Float mouseX;
HXDLIN( 340)		if ((this->get_mouseX() < 0)) {
HXLINE( 340)			mouseX = ( (Float)(0) );
            		}
            		else {
HXLINE( 340)			mouseX = this->get_mouseX();
            		}
HXLINE( 341)		Float mouseY;
HXDLIN( 341)		if ((this->get_mouseY() < 0)) {
HXLINE( 341)			mouseY = ( (Float)(0) );
            		}
            		else {
HXLINE( 341)			mouseY = this->get_mouseY();
            		}
HXLINE( 343)		if (!(this->parent->get_visible())) {
HXLINE( 345)			this->_overHandle = (this->_overHeader = false);
HXLINE( 346)			return;
            		}
HXLINE( 349)		if (this->_dragging) {
HXLINE( 351)			this->_overHeader = true;
HXLINE( 352)			Float _hx_tmp = this->parent->get_mouseX();
HXDLIN( 352)			Float _hx_tmp1 = (_hx_tmp - this->_drag->x);
HXDLIN( 352)			Float _hx_tmp2 = this->parent->get_mouseY();
HXDLIN( 352)			this->reposition(_hx_tmp1,(_hx_tmp2 - this->_drag->y));
            		}
            		else {
HXLINE( 354)			if (this->_resizing) {
HXLINE( 356)				this->_overHandle = true;
HXLINE( 357)				this->resize((mouseX - this->_drag->x),(mouseY - this->_drag->y));
            			}
            			else {
HXLINE( 359)				bool _hx_tmp3;
HXDLIN( 359)				bool _hx_tmp4;
HXDLIN( 359)				bool _hx_tmp5;
HXDLIN( 359)				if ((mouseX >= 0)) {
HXLINE( 359)					_hx_tmp5 = (mouseX <= this->_width);
            				}
            				else {
HXLINE( 359)					_hx_tmp5 = false;
            				}
HXDLIN( 359)				if (_hx_tmp5) {
HXLINE( 359)					_hx_tmp4 = (mouseY >= 0);
            				}
            				else {
HXLINE( 359)					_hx_tmp4 = false;
            				}
HXDLIN( 359)				if (_hx_tmp4) {
HXLINE( 359)					_hx_tmp3 = (mouseY <= this->_height);
            				}
            				else {
...
HXDLIN( 361)					if ((mouseX <= this->_header->get_width())) {
HXLINE( 361)						_hx_tmp6 = (mouseY <= this->_header->get_height());
            					}
            					else {
HXLINE( 361)						_hx_tmp6 = false;
            					}
HXDLIN( 361)					this->_overHeader = _hx_tmp6;
HXLINE( 362)					if (this->_resizable) {
HXLINE( 364)						bool _hx_tmp7;
HXDLIN( 364)						int _hx_tmp8 = this->_width;
HXDLIN( 364)						if ((mouseX >= (( (Float)(_hx_tmp8) ) - this->_handle->get_width()))) {
HXLINE( 364)							int _hx_tmp9 = this->_height;
HXDLIN( 364)							_hx_tmp7 = (mouseY >= (( (Float)(_hx_tmp9) ) - this->_handle->get_height()));
            						}
            						else {
HXLINE( 364)							_hx_tmp7 = false;
            						}
HXDLIN( 364)						this->_overHandle = _hx_tmp7;
            					}
            				}
            				else {
HXLINE( 369)					this->_overHandle = (this->_overHeader = false);
            				}
            			}
            		}
            	}
...
void Window_obj::onMouseDown( ::openfl::events::MouseEvent _){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_378_onMouseDown)
HXDLIN( 378)		if (this->_overHeader) {
HXLINE( 380)			if (this->_alwaysOnTop) {
HXLINE( 381)				this->parent->addChild(::hx::ObjectPtr<OBJ_>(this));
            			}
HXLINE( 382)			this->_dragging = true;
HXLINE( 383)			this->_drag->x = this->get_mouseX();
HXLINE( 384)			this->_drag->y = this->get_mouseY();
            		}
            		else {
HXLINE( 386)			if (this->_overHandle) {
HXLINE( 388)				if (this->_alwaysOnTop) {
HXLINE( 389)					this->parent->addChild(::hx::ObjectPtr<OBJ_>(this));
            				}
HXLINE( 390)				this->_resizing = true;
HXLINE( 391)				int _hx_tmp = this->_width;
HXDLIN( 391)				Float _hx_tmp1 = this->get_mouseX();
HXDLIN( 391)				this->_drag->x = (( (Float)(_hx_tmp) ) - _hx_tmp1);
HXLINE( 392)				int _hx_tmp2 = this->_height;
HXDLIN( 392)				Float _hx_tmp3 = this->get_mouseY();
HXDLIN( 392)				this->_drag->y = (( (Float)(_hx_tmp2) ) - _hx_tmp3);
            			}
            		}
            	}
...
void Window_obj::onMouseUp( ::openfl::events::MouseEvent _){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_400_onMouseUp)
HXLINE( 401)		this->_dragging = false;
HXLINE( 402)		this->_resizing = false;
            	}
...
void Window_obj::bound(){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_410_bound)
HXDLIN( 410)		if (::hx::IsNotNull( this->_bounds )) {
HXLINE( 412)			Float Value = this->get_x();
HXDLIN( 412)			 ::Dynamic Min = this->_bounds->get_left();
HXDLIN( 412)			Float Max = this->_bounds->get_right();
HXDLIN( 412)			 ::Dynamic Max1 = (Max - ( (Float)(this->_width) ));
HXDLIN( 412)			Float lowerBound;
HXDLIN( 412)			bool lowerBound1;
HXDLIN( 412)			if (::hx::IsNotNull( Min )) {
HXLINE( 412)				lowerBound1 = ::hx::IsLess( Value,Min );
            			}
            			else {
HXLINE( 412)				lowerBound1 = false;
            			}
HXDLIN( 412)			if (lowerBound1) {
HXLINE( 412)				lowerBound = ( (Float)(Min) );
            			}
            			else {
HXLINE( 412)				lowerBound = Value;
            			}
HXDLIN( 412)			Float _hx_tmp;
HXDLIN( 412)			bool _hx_tmp1;
HXDLIN( 412)			if (::hx::IsNotNull( Max1 )) {
HXLINE( 412)				_hx_tmp1 = ::hx::IsGreater( lowerBound,Max1 );
            			}
            			else {
HXLINE( 412)				_hx_tmp1 = false;
            			}
HXDLIN( 412)			if (_hx_tmp1) {
HXLINE( 412)				_hx_tmp = ( (Float)(Max1) );
            			}
            			else {
HXLINE( 412)				_hx_tmp = lowerBound;
            			}
HXDLIN( 412)			this->set_x(_hx_tmp);
HXLINE( 413)			Float Value1 = this->get_y();
HXDLIN( 413)			 ::Dynamic Min1 = this->_bounds->get_top();
HXDLIN( 413)			Float Max2 = this->_bounds->get_bottom();
HXDLIN( 413)			 ::Dynamic Max3 = (Max2 - ( (Float)(this->_height) ));
HXDLIN( 413)			Float lowerBound2;
HXDLIN( 413)			bool lowerBound3;
HXDLIN( 413)			if (::hx::IsNotNull( Min1 )) {
HXLINE( 413)				lowerBound3 = ::hx::IsLess( Value1,Min1 );
            			}
            			else {
HXLINE( 413)				lowerBound3 = false;
            			}
HXDLIN( 413)			if (lowerBound3) {
HXLINE( 413)				lowerBound2 = ( (Float)(Min1) );
            			}
            			else {
HXLINE( 413)				lowerBound2 = Value1;
            			}
HXDLIN( 413)			Float _hx_tmp2;
HXDLIN( 413)			bool _hx_tmp3;
HXDLIN( 413)			if (::hx::IsNotNull( Max3 )) {
HXLINE( 413)				_hx_tmp3 = ::hx::IsGreater( lowerBound2,Max3 );
            			}
            			else {
HXLINE( 413)				_hx_tmp3 = false;
            			}
HXDLIN( 413)			if (_hx_tmp3) {
HXLINE( 413)				_hx_tmp2 = ( (Float)(Max3) );
            			}
            			else {
HXLINE( 413)				_hx_tmp2 = lowerBound2;
            			}
HXDLIN( 413)			this->set_y(_hx_tmp2);
            		}
            	}
...
void Window_obj::updateSize(){
            	HX_STACKFRAME(&_hx_pos_4e51d5a8805713a4_421_updateSize)
HXLINE( 422)		Float Value = ( (Float)(this->_width) );
HXDLIN( 422)		 ::Dynamic Min = this->minSize->x;
HXDLIN( 422)		 ::Dynamic Max = this->maxSize->x;
HXDLIN( 422)		Float lowerBound;
HXDLIN( 422)		bool lowerBound1;
HXDLIN( 422)		if (::hx::IsNotNull( Min )) {
HXLINE( 422)			lowerBound1 = ::hx::IsLess( Value,Min );
            		}
            		else {
HXLINE( 422)			lowerBound1 = false;
            		}
HXDLIN( 422)		if (lowerBound1) {
HXLINE( 422)			lowerBound = ( (Float)(Min) );
            		}
            		else {
HXLINE( 422)			lowerBound = Value;
            		}
HXDLIN( 422)		Float _hx_tmp;
HXDLIN( 422)		bool _hx_tmp1;
HXDLIN( 422)		if (::hx::IsNotNull( Max )) {
HXLINE( 422)			_hx_tmp1 = ::hx::IsGreater( lowerBound,Max );
            		}
            		else {
HXLINE( 422)			_hx_tmp1 = false;
            		}
HXDLIN( 422)		if (_hx_tmp1) {
HXLINE( 422)			_hx_tmp = ( (Float)(Max) );
            		}
            		else {
HXLINE( 422)			_hx_tmp = lowerBound;
            		}
HXDLIN( 422)		this->_width = ::Std_obj::_hx_int(_hx_tmp);
HXLINE( 423)		Float Value1 = ( (Float)(this->_height) );
HXDLIN( 423)		 ::Dynamic Min1 = this->minSize->y;
HXDLIN( 423)		 ::Dynamic Max1 = this->maxSize->y;
HXDLIN( 423)		Float lowerBound2;
HXDLIN( 423)		bool lowerBound3;
HXDLIN( 423)		if (::hx::IsNotNull( Min1 )) {
HXLINE( 423)			lowerBound3 = ::hx::IsLess( Value1,Min1 );
            		}
            		else {
HXLINE( 423)			lowerBound3 = false;
            		}
HXDLIN( 423)		if (lowerBound3) {
HXLINE( 423)			lowerBound2 = ( (Float)(Min1) );
            		}
            		else {
HXLINE( 423)			lowerBound2 = Value1;
            		}
HXDLIN( 423)		Float _hx_tmp2;
HXDLIN( 423)		bool _hx_tmp3;
HXDLIN( 423)		if (::hx::IsNotNull( Max1 )) {
HXLINE( 423)			_hx_tmp3 = ::hx::IsGreater( lowerBound2,Max1 );
            		}
            		else {
HXLINE( 423)			_hx_tmp3 = false;
            		}
HXDLIN( 423)		if (_hx_tmp3) {
HXLINE( 423)			_hx_tmp2 = ( (Float)(Max1) );
            		}
            		else {
HXLINE( 423)			_hx_tmp2 = lowerBound2;
            		}
HXDLIN( 423)		this->_height = ::Std_obj::_hx_int(_hx_tmp2);
HXLINE( 425)		this->_header->set_scaleX(( (Float)(this->_width) ));
HXLINE( 426)		this->_background->set_scaleX(( (Float)(this->_width) ));
HXLINE( 427)		 ::openfl::display::Bitmap _hx_tmp4 = this->_background;
HXDLIN( 427)		int _hx_tmp5 = this->_height;
HXDLIN( 427)		_hx_tmp4->set_scaleY((( (Float)(_hx_tmp5) ) - this->_header->get_height()));
HXLINE( 428)		this->_shadow->set_scaleX(( (Float)(this->_width) ));
HXLINE( 429)		this->_shadow->set_y(( (Float)(this->_height) ));
HXLINE( 430)		this->_title->set_width(( (Float)((this->_width - 4)) ));
HXLINE( 431)		if (this->_resizable) {
HXLINE( 433)			 ::openfl::display::Bitmap _hx_tmp6 = this->_handle;
HXDLIN( 433)			int _hx_tmp7 = this->_width;
HXDLIN( 433)			_hx_tmp6->set_x((( (Float)(_hx_tmp7) ) - this->_handle->get_width()));
HXLINE( 434)			 ::openfl::display::Bitmap _hx_tmp8 = this->_handle;
HXDLIN( 434)			int _hx_tmp9 = this->_height;
HXDLIN( 434)			_hx_tmp8->set_y((( (Float)(_hx_tmp9) ) - this->_handle->get_height()));
            		}
HXLINE( 436)		if (::hx::IsNotNull( this->_closeButton )) {
HXLINE( 438)			 ::flixel::_hx_system::ui::FlxSystemButton _hx_tmp10 = this->_closeButton;
HXDLIN( 438)			int _hx_tmp11 = this->_width;
HXDLIN( 438)			_hx_tmp10->set_x(((( (Float)(_hx_tmp11) ) - this->_closeButton->get_width()) - ( (Float)(3) )));
HXLINE( 439)			this->_closeButton->set_y(( (Float)(3) ));
            		}
            	}
