...
HX_LOCAL_STACK_FRAME(_hx_pos_1a8263561f5674e9_77_getData,"flixel.system._FlxAssets.FlxJsonAsset_Impl_","getData",0x4df94853,"flixel.system._FlxAssets.FlxJsonAsset_Impl_.getData","flixel/system/FlxAssets.hx",77,0xd3ac1356)
HX_LOCAL_STACK_FRAME(_hx_pos_1a8263561f5674e9_92_fromPath,"flixel.system._FlxAssets.FlxJsonAsset_Impl_","fromPath",0x5fe4965c,"flixel.system._FlxAssets.FlxJsonAsset_Impl_.fromPath","flixel/system/FlxAssets.hx",92,0xd3ac1356)
HX_LOCAL_STACK_FRAME(_hx_pos_1a8263561f5674e9_97_fromDataString,"flixel.system._FlxAssets.FlxJsonAsset_Impl_","fromDataString",0x07608292,"flixel.system._FlxAssets.FlxJsonAsset_Impl_.fromDataString","flixel/system/FlxAssets.hx",97,0xd3ac1356)
namespace flixel{
...
bool FlxJsonAsset_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic FlxJsonAsset_Impl__obj::getData( ::Dynamic this1){
            	HX_GC_STACKFRAME(&_hx_pos_1a8263561f5674e9_77_getData)
HXLINE(  78)		if (::Std_obj::isOfType(this1,::hx::ClassOf< ::String >())) {
HXLINE(  80)			::String str = ( (::String)(this1) );
HXLINE(  81)			if (::openfl::utils::Assets_obj::exists(str,null())) {
HXLINE(  82)				return  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,::openfl::utils::Assets_obj::getText(str))->doParse();
            			}
HXLINE(  84)			return  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,str)->doParse();
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxJsonAsset_Impl__obj,getData,return )
 ...
 ::Dynamic FlxJsonAsset_Impl__obj::fromPath(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_1a8263561f5674e9_92_fromPath)
HXDLIN(  92)		return  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,::openfl::utils::Assets_obj::getText(path))->doParse();
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxJsonAsset_Impl__obj,fromPath,return )
 ...
 ::Dynamic FlxJsonAsset_Impl__obj::fromDataString(::String data){
            	HX_GC_STACKFRAME(&_hx_pos_1a8263561f5674e9_97_fromDataString)
HXDLIN(  97)		return  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,data)->doParse();
            	}
