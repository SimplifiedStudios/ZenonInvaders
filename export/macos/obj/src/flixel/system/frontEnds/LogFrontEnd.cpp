...
HX_LOCAL_STACK_FRAME(_hx_pos_ba09e0c9e62cea6b_106_clear,"flixel.system.frontEnds.LogFrontEnd","clear",0x4a0034fb,"flixel.system.frontEnds.LogFrontEnd.clear","flixel/system/frontEnds/LogFrontEnd.hx",106,0x686ab8c3)
HX_LOCAL_STACK_FRAME(_hx_pos_ba09e0c9e62cea6b_119_set_redirectTraces,"flixel.system.frontEnds.LogFrontEnd","set_redirectTraces",0xf7f71199,"flixel.system.frontEnds.LogFrontEnd.set_redirectTraces","flixel/system/frontEnds/LogFrontEnd.hx",119,0x686ab8c3)
HX_LOCAL_STACK_FRAME(_hx_pos_ba09e0c9e62cea6b_131_processTraceData,"flixel.system.frontEnds.LogFrontEnd","processTraceData",0x5a916632,"flixel.system.frontEnds.LogFrontEnd.processTraceData","flixel/system/frontEnds/LogFrontEnd.hx",131,0x686ab8c3)
namespace flixel{
...
HXLINE( 115)		this->_standardTraceFunction = ::haxe::Log_obj::trace;
            	}
...
void LogFrontEnd_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_ba09e0c9e62cea6b_106_clear)
            	}
...
bool LogFrontEnd_obj::set_redirectTraces(bool Redirect){
            	HX_STACKFRAME(&_hx_pos_ba09e0c9e62cea6b_119_set_redirectTraces)
HXLINE( 120)		 ::Dynamic _hx_tmp;
HXDLIN( 120)		if (Redirect) {
HXLINE( 120)			_hx_tmp = this->processTraceData_dyn();
            		}
            		else {
HXLINE( 120)			_hx_tmp = this->_standardTraceFunction;
            		}
HXDLIN( 120)		::haxe::Log_obj::trace = _hx_tmp;
HXLINE( 121)		return (this->redirectTraces = Redirect);
            	}
...
void LogFrontEnd_obj::processTraceData( ::Dynamic Data, ::Dynamic Info){
            	HX_STACKFRAME(&_hx_pos_ba09e0c9e62cea6b_131_processTraceData)
HXLINE( 132)		::cpp::VirtualArray paramArray = ::cpp::VirtualArray_obj::__new(1)->init(0,Data);
HXLINE( 134)		if (::hx::IsNotNull( Info->__Field(HX_("customParams",d7,51,18,ed),::hx::paccDynamic) )) {
HXLINE( 136)			int _g = 0;
HXDLIN( 136)			::cpp::VirtualArray _g1 = ( (::cpp::VirtualArray)(Info->__Field(HX_("customParams",d7,51,18,ed),::hx::paccDynamic)) );
HXDLIN( 136)			while((_g < _g1->get_length())){
HXLINE( 136)				 ::Dynamic i = _g1->__get(_g);
HXDLIN( 136)				_g = (_g + 1);
HXLINE( 138)				paramArray->push(i);
            			}
            		}
HXLINE( 142)		this->advanced(paramArray,::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL,null());
            	}
