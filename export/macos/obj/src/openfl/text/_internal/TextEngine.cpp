...
HXLINE( 360)			 ::openfl::text::Font serifBold = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Times New Roman Bold.ttf",d5,4f,1d,7d));
HXLINE( 361)			 ::openfl::text::Font serifItalic = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Times New Roman Italic.ttf",c0,54,36,d2));
HXLINE( 362)			 ::openfl::text::Font serifBoldItalic = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Times New Roman Bold Italic.ttf",eb,ef,fd,67));
HXLINE( 364)			{
HXLINE( 364)				::Dynamic this2 = ::openfl::text::_internal::TextEngine_obj::_hx___defaultFonts;
HXDLIN( 364)				( ( ::haxe::ds::StringMap)(this2) )->set(HX_("_serif",be,66,15,76), ::openfl::text::_internal::_TextEngine::DefaultFontSet_obj::__alloc( HX_CTX ,serif,serifBold,serifItalic,serifBoldItalic));
            			}
HXLINE( 366)			 ::openfl::text::Font typewriter = ( ( ::openfl::text::Font)(processFontList(::Array_obj< ::String >::__new(9)->init(0,(systemFontDirectory + HX_("/Courier New.ttf",d6,e1,80,a0)))->init(1,(systemFontDirectory + HX_("/Courier.ttf",b6,7e,38,40)))->init(2,(systemFontDirectory + HX_("/Cache/Courier New.ttf",69,77,b8,0d)))->init(3,(systemFontDirectory + HX_("/Cache/Courier.ttf",c9,0e,4b,98)))->init(4,(systemFontDirectory + HX_("/Core/Courier New.ttf",04,cb,ad,96)))->init(5,(systemFontDirectory + HX_("/Core/Courier.ttf",e4,b8,d1,3b)))->init(6,(systemFontDirectory + HX_("/CoreAddition/Courier New.ttf",20,ca,dd,d5)))->init(7,(systemFontDirectory + HX_("/CoreAddition/Courier.ttf",00,fa,94,32)))->init(8,HX_("/System/Library/Fonts/Supplemental/Courier New.ttf",0a,22,a4,92)))) );
HXLINE( 377)			 ::openfl::text::Font typewriterBold = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Courier New Bold.ttf",eb,47,af,10));
HXLINE( 378)			 ::openfl::text::Font typewriterItalic = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Courier New Italic.ttf",56,fe,46,e8));
HXLINE( 379)			 ::openfl::text::Font typewriterBoldItalic = ::openfl::text::_internal::TextEngine_obj::findFont(HX_("/System/Library/Fonts/Supplemental/Courier New Bold Italic.ttf",95,c6,70,a1));
HXLINE( 381)			{
HXLINE( 381)				::Dynamic this3 = ::openfl::text::_internal::TextEngine_obj::_hx___defaultFonts;
HXDLIN( 381)				( ( ::haxe::ds::StringMap)(this3) )->set(HX_("_typewriter",0c,5e,52,94), ::openfl::text::_internal::_TextEngine::DefaultFontSet_obj::__alloc( HX_CTX ,typewriter,typewriterBold,typewriterItalic,typewriterBoldItalic));
            			}
            		}
