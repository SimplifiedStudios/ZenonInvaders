...
HXLINE(  70)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf >());
HXLINE(  71)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__flixel_fonts_monsterrat_ttf >());
HXLINE(  75)		 ::Dynamic data;
HXDLIN(  75)		 ::Dynamic manifest;
HXDLIN(  75)		 ::Dynamic bundle;
HXLINE(  88)		{
HXLINE(  88)			::String v = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  88)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v);
            		}
HXLINE(  75)		 ::lime::utils::AssetLibrary library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE(  92)		if (::hx::IsNotNull( library )) {
HXLINE(  92)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  93)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
